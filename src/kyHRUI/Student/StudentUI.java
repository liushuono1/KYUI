...
public class StudentUI extends ClientUI implements UpdateableUI,
		PrintableDetailUI {
	...
	public StudentUI() {
		...
		generalPane = new StudentUIGeneralPane();
			...
			btnShowTrain.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					try {
						...
						ClientUtil.setupWindow(StudentUI.this);
					} catch (ServerActionException e1) {
						ClientUtil.showException(e1);
	...
	StudentUIGeneralPane generalPane;
